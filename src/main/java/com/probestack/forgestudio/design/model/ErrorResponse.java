 ...
 * ErrorResponse
 */
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-08-13T10:37:09.209445517Z[GMT]")public class ErrorResponse {
  ...
  */
   ...
   * @return errorCode
  */
    @Schema(name = "errorCode", example = "INVALID_QUANTITY", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
   ...
   * @return message
  */
  @NotNull   @Schema(name = "message", example = "Validation failed: quantity must be at least 1", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
   ...
   * @return path
  */
    @Schema(name = "path", example = "/v1/carts", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("path")
